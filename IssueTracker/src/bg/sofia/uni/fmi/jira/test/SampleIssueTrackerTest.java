...
import bg.sofia.uni.fmi.jira.test.TestUtils;
...
public class SampleIssueTrackerTest {
	...
	@BeforeClass
	public static void setUp() throws InvalidReporterException, InvalidComponentException, InvalidPriorityException, InvalidDescriptionException {
		ivan = new User("Ivan");
